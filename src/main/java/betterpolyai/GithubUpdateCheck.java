...
public final class GithubUpdateCheck {
    ...
    private static final String repo = "BetterPolyAi";
    private static final String modName = "betterpolyai";

    private static final String keyUpdateCheckEnabled = "bpa-updatecheck";
    private static final String keyUpdateCheckShowDialog = "bpa-updatecheck-dialog";
    private static final String keyUpdateCheckLastAt = "bpa-updatecheck-lastAt";
    private static final String keyUpdateCheckIgnoreVersion = "bpa-updatecheck-ignore";
